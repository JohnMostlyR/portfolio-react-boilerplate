...
const {
  inlineLink: { color, textShadowColor },
} = theme.projectDetails;
const H2_LINE_HEIGHT = 1.2;
const EXTERNAL_LINK_ICON = SVGBackgroundImage(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" aria-hidden="true">
    <path
      fill="${color}"
