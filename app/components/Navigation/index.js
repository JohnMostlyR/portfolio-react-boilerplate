  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <ListItem>
            <Link to={'/introduction'} tabIndex={isBigScreen ? '0' : '-1'}>
          ...
          <ListItem>
            <Link to={'/about'} tabIndex={isBigScreen ? '0' : '-1'}>
          ...
          <ListItem>
            <Link to={'/skills'} tabIndex={isBigScreen ? '0' : '-1'}>
          ...
          <ListItem>
            <Link to={'/projects'} tabIndex={isBigScreen ? '0' : '-1'}>
              <Icon viewBox="0 0 512 512">
                <path
          ...
          <ListItem>
            <Link to={'/contact'} tabIndex={isBigScreen ? '0' : '-1'}>
              <Icon viewBox="0 0 512 512">
                <path
